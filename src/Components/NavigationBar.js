            ...
            return (
                <nav className="navbar navbar-inverse">
                    ...
                    <ul className="nav navbar-nav ">
                        <li> <a href="#"  onClick={this.props.homeClicked}><span className="glyphicon glyphicon-home"></span> Home</a></li>
                        <li> <a href="#" onClick={this.props.loginClicked}><span className="glyphicon glyphicon-log-in"></span> Login</a></li>
                        <li><a href="#" onClick={this.props.registerClicked}><span className="glyphicon glyphicon-user"></span> Register</a></li>
                    </ul>
                    </div>
                </nav>
            );
